...
export function MediaForm({ data, updateData }: MediaFormProps) {
  ...
  const handleHeaderImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      const reader = new FileReader()
      reader.onload = () => {
        updateData({ headerImageURL: reader.result as string })
      }
      reader.readAsDataURL(file)
    }
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">Add photos and videos to showcase your training style and facilities.</p>
      </div>
      ...
      <div className="space-y-4 mt-6">
        <Label>Profile Header/Banner Image</Label>
        <div className="flex flex-col gap-4">
          <div className="relative w-full h-32 rounded-md overflow-hidden border-2 border-gray-200">
            {data.headerImageURL ? (
              <Image src={data.headerImageURL || "/placeholder.svg"} alt="Header" fill className="object-cover" />
            ) : (
              <div className="w-full h-full bg-gray-100 flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Recommended: 1200x300px banner image for your profile</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-xs text-gray-500">Add photos of your training sessions, facilities, or action shots</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        {data.videoLinks.length > 0 ? (
          ...
          <p className="text-sm text-gray-500 mt-2">
            No videos added yet. Add links to your training videos to showcase your expertise.
          </p>
        )}
      </div>
      ...
      <Alert className="bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-700">
          High-quality photos and videos can significantly increase your booking rate. Athletes want to see your
          training style before they book.
        </AlertDescription>
      </Alert>
    </div>
  )
